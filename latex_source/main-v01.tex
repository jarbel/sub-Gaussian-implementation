...
$_{1}$\textsf{julyan.arbel@inria.fr},
$_{2}$\textsf{soufiiane.atouanii@gmail.com},
...
Lemmas \ref{LemmaNumber} and \ref{LemmaNumber2} can be put together to obtain the following proposition.
...
\sloppy{Olivier Marchal was supported by the fundamental junior IUF grant G752IUFMAR. We would like to thank ...}
